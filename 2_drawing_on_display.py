...
display_surface.fill(MAGNETA)

# Draw various shapes on our display
# Line(surface, color, starting, ending point, thickness)
pygame.draw.line(display_surface, GREEN,(0,0),(100,100), 5)
pygame.draw.line(display_surface,BLUE, (100,100), (200,300), 1)

# Circle(surface, color,starting point, ending point, thickness)
...
# Rektangel(surface, color,(top-left x, top-left y,  width, height))
pygame.draw.rect(display_surface,BLUE,(500, 0, 100, 100))
pygame.draw.rect(display_surface,BLACK,(500, 100, 50, 100))
# The main game loop
running = True
while running:
